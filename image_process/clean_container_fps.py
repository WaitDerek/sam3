...
from material_paths import CONFIG_DIR, TOOL_DIR

ROOT = TOOL_DIR
CONFIG_PATH = CONFIG_DIR / "object_segmentation_params.json"
...
# loaded from image_process/configs/object_segmentation_params.json so capture
# identifiers do not live in script code.
...
INPUT_DIRS = {
    "air_filter": ROOT / "dataset/空滤器进气连接管总成_560",
    "bumper_624": ROOT / "dataset/前保险杠侧安装支架总成_624/bgr",
    "washer_filler_769": ROOT / "dataset/洗涤器水壶加注管总成_769",
    "foam_block_979": ROOT / "dataset/后轮鼓包内后侧泡沫块_979/bgr",
    "fresh_air_vent": ROOT / "dataset/空调新风口总成_906/bgr",
    "passenger_window_switch": ROOT / "dataset/副电动车窗开关总成_697",
    "passenger_wiper_1113": ROOT / "dataset/副雨刮器总成_1113/bgr",
    "power_tailgate_system_854": ROOT / "dataset/背门自动开闭系统ECU控制器总成_854/bgr",
    "screw_cover": ROOT / "dataset/前门内开手柄盒螺钉盖板_908",
    "warning_triangle_486": ROOT / "dataset/三角警告牌_486/bgr",
}
